...
interface CreateTrendViewProps {
  onNavigate: (page: string) => void;
}

export function CreateTrendView({ onNavigate }: CreateTrendViewProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FFFBF7" }}>
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          <h1 className="text-3xl mb-8">새 트렌드 등록</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="3d-ui">3D UI</option>
                <option value="ui-trend">UI Trend</option>
              </select>
            </div>
